...
import com.ecom.cartify.dto.CartItemResponse;
import com.ecom.cartify.entity.CartItem;
import com.ecom.cartify.service.CartService;
...
public class CartController {
    ...
    public ResponseEntity<String> addToCart(@RequestHeader("X-User-ID") String userId,@RequestBody CartItemRequest request){
        ...
        if(!cartService.addToCart(userId, request)){
            return ResponseEntity.badRequest().body("Product Out of Stock or User not found or Prodct not found");
        }
